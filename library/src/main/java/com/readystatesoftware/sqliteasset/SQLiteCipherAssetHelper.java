 ...
 */
public class SQLiteCipherAssetHelper extends SQLiteOpenHelper {

    private static final String TAG = SQLiteCipherAssetHelper.class.getSimpleName();
     ...
     */
    public SQLiteCipherAssetHelper(Context context, String name, String storageDirectory, CursorFactory factory, int version) {
     ...
     *     upgrade the database
     */
    public SQLiteCipherAssetHelper(Context context, String name, CursorFactory factory, int version) {
    ...
    public synchronized SQLiteDatabase getWritableDatabase(String password) {
        ...
        try {
            ...
            //}
            db = createOrOpenDatabase(false, password);

            int version = db.getVersion();

            // do force upgrade
            if (version != 0 && version < mForcedUpgradeVersion) {
                db = createOrOpenDatabase(true, password);
    ...
    private SQLiteDatabase createOrOpenDatabase(boolean force, String password) throws SQLiteAssetException {
        ...
        if (file.exists()) {
            db = returnDatabase(password);
        }
        //SQLiteDatabase db = returnDatabase(password);
    ...
    private SQLiteDatabase returnDatabase(String password) {
        try {
